...
define Device/xuanying_sy910
$(call Device/Legacy/rk3528,$(1))
  DEVICE_VENDOR := Xuanying
  DEVICE_MODEL := SY910
  DEVICE_DTS := rk3528/rk3528-sy910
  UBOOT_DEVICE_NAME :=   
  DEVICE_PACKAGES += kmod-usb-net kmod-usb-net-rtl8152 kmod-usb-net-asix \
	kmod-usb-net-asix-ax88179 kmod-usb-net-smsc95xx
endef
TARGET_DEVICES += xuanying_sy910
